...
export const reviews = [
  {
    ...
    comment:
    "I had the pleasure of exploring EduClarity, a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience, as the website offers a comprehensive selection of courses that cater to different skill levels and interests. If you're looking to enhance your knowledge and skills in the tech industry, I highly recommend checking out EduClarity!",
},
  {
    name: "Verna Santos",
    ...
    "Thanks for your amazing programming tutorial channel! Your teaching style is outstanding, and the quality of your tutorials is top-notch. Your ability to break down complex topics into manageable parts, and cover diverse programming languages and topics is truly impressive. The practical applications and real-world examples you incorporate reinforce the theoretical knowledge and provide valuable insights."},
  {
    ...
    comment:
    "I had the pleasure of exploring EduClarity, a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience",
},
  {
    name: "Rosemary Smith",
  ...
  <div className="w-[90%] 800px:w-[85%] m-auto">
      ...
      <div className="800px:w-[50%] w-full">
        ...
        <div className="800px:w-[50%] w-full">
          ...
          Our students are the driving force behind our success, inspiring us every step of the way. Their achievements and feedback motivate us to continually improve and excel. We take pride in nurturing their potential and celebrating their milestones. Together, we create a thriving community where learning knows no bounds.
          </p>
        </div>
        <br />
        <br />
